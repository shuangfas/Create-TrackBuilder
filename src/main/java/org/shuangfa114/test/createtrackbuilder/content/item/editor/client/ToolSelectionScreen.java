...
public class ToolSelectionScreen extends Screen {
    ...
    protected List<EditorToolType> tools;
    protected Consumer<EditorToolType> callback;
    ...
    protected ToolSelectionScreen(List<EditorToolType> tools, Consumer<EditorToolType> callback) {
    ...
    public void setSelectedElement(EditorToolType tool) {
    ...
    private void draw(GuiGraphics graphics, float partialTicks) {
        ...
        RenderSystem.setShaderColor(1, 1, 1, focused ? 5 / 8f : 1/2f);
        ...
        if (toolTipAlpha > 0.25f) {
            ...
            for (int i = 1; i < toolTip.size(); i++) {
                graphics.drawString(font, toolTip.get(i), x - 10, y + 40 + i * 10, 0xCCDDFF + stringAlphaComponent, false);
            }
        }
